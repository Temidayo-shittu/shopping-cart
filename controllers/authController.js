...
const {createJWT, attachCookiesToResponse, isValidToken, createTokenUser}= require('../utils')
...
const login= async(req,res)=>{
    ...
    if(!email || !password) throw new CustomError.BadRequestError('Please provide both email and password')
